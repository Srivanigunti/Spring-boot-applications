...
import com.cg.app.account.SortAccountByBalanceInAscending;
import com.cg.app.account.SortAccountByBalanceInDescending;
...
public class AccountCUI {
	...
	private void performOperation(int choice) throws ClassNotFoundException, SQLException {
		...
		case 2:
			...
			System.out.println("Enter " + "2" + " to Update Your SalaryType ");
			System.out.println("Enter " + "3" + " to Update both Name and Salary Type");
	...
	private void selectOptionsToUpdate(int select, SavingsAccount savingsAccount2) {
		...
		case 2:
			...
			System.out.println("If your account type is unsalaried enter (y)to change your account type as salaried");
	...
	private void sortAccounts() throws ClassNotFoundException, SQLException {
		do {
			System.out.println("Enter the choice in which you want to sort the Accounts:");
	...
	private void sortType(int choiceType) throws ClassNotFoundException, SQLException {
		switch (choiceType) {
		case 1:
			do {
	...
	private void sortFieldsInAscending(int choice) throws ClassNotFoundException, SQLException {
		switch (choice) {
		case 1:
			try {
				List<SavingsAccount> savingsAccounts = savingsAccountService.getAllSavingsAccount();
				Collections.sort(savingsAccounts, new SortAccountByHolderNameInAscending());
		...
		case 2:
			List<SavingsAccount> savingsAccounts = savingsAccountService.getAllSavingsAccount();
			Collections.sort(savingsAccounts, new SortAccountByBalanceInAscending());
			for (SavingsAccount savingsAccount : savingsAccounts) {
				System.out.println(savingsAccount);
			}
			break;
	...
	private void sortFieldsInDescending(int choice) throws ClassNotFoundException, SQLException {
		switch (choice) {
		case 1:
			try {
				List<SavingsAccount> savingsAccounts = savingsAccountService.getAllSavingsAccount();
				Collections.sort(savingsAccounts, new SortAccountByHolderNameInDescending());
				for (SavingsAccount savingsAccount : savingsAccounts) {
					System.out.println(savingsAccount);
				}
			} catch (ClassNotFoundException | SQLException e) {
		...
		case 2:
			List<SavingsAccount> savingsAccounts = savingsAccountService.getAllSavingsAccount();
			Collections.sort(savingsAccounts, new SortAccountByBalanceInDescending());
			for (SavingsAccount savingsAccount : savingsAccounts) {
				System.out.println(savingsAccount);
			}
			break;
	...
	private void searchAccount() throws ClassNotFoundException, SQLException {
		do {
	...
	private void searchAccountByChoice(int choice) throws ClassNotFoundException, SQLException {
		switch (choice) {
		case 1:
			...
			try {
				getAccountById = savingsAccountService.getAccountById(accountNumber);
		...
		case 2:
			...
			try {
				getAccountByName = savingsAccountService.getAccountByName(accountHolderName);
				System.out.println("Your Account Details is:" + getAccountByName);
			} catch (ClassNotFoundException | SQLException | AccountNotFoundException e) {
				e.printStackTrace();
			}
			break;
		case 3:
			System.out.println("Enter the maximum and minimum amount that you want to search:");
			...
			try {
				savingsAccounts = savingsAccountService.getAccountsBetweenTheSalary(minimum, maximum);
				for (SavingsAccount savingsAccount : savingsAccounts) {
					System.out.println(savingsAccount);
				}
			} catch (ClassNotFoundException | SQLException e) {
